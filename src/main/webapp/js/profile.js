    ...
    await $.ajax({
        ...
        success: function (result) {
            ...
            if (parsedResult !== false) {
                ...
                $("#input-saldo").val(parsedResult.saldo.toFixed(0));
    ...
    if (peliculas.length >= 1) {
        ...
        $.each(peliculas, function (index, pelicula) {
            ...
            contenido += '></td><td>' + pelicula.fechaAlquiler + '</td>' +
                '<td><button id="devolver-btn" onclick= "devolverPelicula(' + pelicula.id + ');" class="btn btn-danger">Devolver pelicula</button></td></tr>';
